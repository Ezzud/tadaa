...
console.log = function(d) {
    ...
    manager.reroll(args[0]).then(() => {
        message.react('✅');
        let yembed = new Discord.MessageEmbed().setColor('24E921').setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`).setDescription(`${okay} *Le(s) nouveau(x) gagnant(s) a|ont été sélectionné(s)*`).setFooter(`TADAA | v${json.version}`)
