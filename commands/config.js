...
module.exports.run = async (client,pf,message,args,nope,info,okay,what,warning,manager) => {
    ...
    var database = low(adapting);
        ...
        .setDescription(`${nope} Vous n'avez pas la permission`)
    ...
    if(dmWin === true) {
        ...
        if(args[0] === 'prefix') {
            if(!args[1]) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} Veuillez renseigner un préfixe`)
                .addField(`Syntaxe`, `${pf}config prefix \`<Nouveau préfixe>\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                return;
            }
            if(args[1] === await database.get(`data.prefix`).value()) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} Le nouveau préfixe est le même que l'ancien`)
                .addField(`Syntaxe`, `${pf}config prefix \`<Nouveau préfixe>\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                return;
            ...
            await database.set(`data.prefix`, args[1]).write()
                ...
                .setColor('24E921')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${okay} Le préfixe du bot est désormais \`${await database.get(`data.prefix`).value()}\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
            ...
            if(!args[1]) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Veuillez renseigner une valeur* \`(Oui/Non)\` `)
                .addField(`Syntaxe`, `${pf}config prefix \`<Nouveau préfixe>\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                return;
            ...
            if(args[1].toLowerCase() === 'oui') {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Les messages privés sont déjà activés*`)
                .addField(`Syntaxe`, `${pf}config prefix \`<Nouveau préfixe>\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                    return;
                ...
                .setColor('24E921')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${okay} *L'envoi de message privé aux gagnants est désormais \`activé\`*`)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Les messages privés sont déjà désactivés*`)
                .addField(`Syntaxe`, `${pf}config prefix \`<Nouveau préfixe>\``)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
                    return;
                ...
                .setColor('24E921')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${okay} *L'envoi de message privé aux gagnants est désormais \`désactivé\`*`)
                .setFooter(`TADAA | créé par ezzud`)
                message.channel.send(embed)
            } else {
                let embed = new Discord.MessageEmbed()
