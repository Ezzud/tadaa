      ...
      if(role !== undefined && role !== false && role !== null)  {
        ...
        if(!message.guild.member(client.user).hasPermission(19456)) return(message.channel.send(permembed));
       	if(!args[0]) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Syntaxe: ${pf}start #salon <durée> <nombre de gagnant> <prix>*`)
                .setFooter(`TADAA | créé par ezzud`)
    	...
    	if(!channel) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Vous devez renseigner un salon*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed));
    	}
        if(channel.type !== 'text') {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Vous devez renseigner un salon __textuel__*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed));
        }
    	let duration = args[1]
    	if(!duration) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Veuillez renseigner une durée*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed));
        }
        ...
        if(!timems) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Veuillez rentrer une durée valide (exemple: 10s, 10m, 10d)*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed));            
        } else {
        ...
        if(!winners) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Veuillez renseigner le nombre de gagnants*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed)); 
        }
        ...
        if(winners === 'NaN') {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Vous devez renseigner un nombre*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed)); 
        } else {
        	winners = parseInt(winners)
        ...
        if(prize.lenght > 100) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Le prix ne peut pas dépasser plus de 100 caractères*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed)); 
        }
    	if(!args[3]) {
                ...
                .setColor('E93C21')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${nope} *Veuillez renseigner un prix*`)
                .setFooter(`TADAA | créé par ezzud`)
            return(message.channel.send(embed)); 
    }
        manager.start(channel, {
            ...
            console.log(`SHARD #${client.shard.ids[0]} - Nouveau giveaway lancé dans le serveur " ${client.guilds.cache.get(gData.guildID).name} "`); 
                ...
                .setColor('24E921')
                .setAuthor(message.author.tag, message.author.avatarURL(), `https://github.com/Ezzud/tadaa`)
                .setDescription(`${okay} *Le giveaway a bien été lançé dans le salon <#${gData.channelID}>*`)
                .setFooter(`TADAA | créé par ezzud`)
