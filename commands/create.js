...
console.log = function(d) {
    ...
    await data.set(`${message.guild.id}.isrequiredserver`, 'Erreur!')
    await data.set(`${message.guild.id}.requiredserver`, 'Erreur!')
    await data.set(`${message.guild.id}.requiredservername`, 'Erreur!')
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.channel`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.time`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
        if (data.get(`${message.guild.id}.creation`) === 'off') {
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.winnerstr`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
        if (data.get(`${message.guild.id}.creation`) === 'off') {
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.price`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
        if (data.get(`${message.guild.id}.creation`) === 'off') {
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.isrequiredrole`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
        if (data.get(`${message.guild.id}.creation`) === 'off') {
...
let mess = collected.first().content
                    ...
                    if (await data.get(`${message.guild.id}.requiredrole`) === 'Erreur!') return;
            ...
            if (data.get(`${message.guild.id}.requiredrole`) === 'Erreur!') {
                await data.set(`${message.guild.id}.creation`, 'off')
                return;
            }
...
let mess = collected.first().content
        ...
        if (data.get(`${message.guild.id}.isrequiredserver`) === 'Erreur!') {
            await data.set(`${message.guild.id}.creation`, 'off')
            return;
        }
        if (data.get(`${message.guild.id}.creation`) === 'off') {
...
let mess = collected.first().content
    ...
    if (data.get(`${message.guild.id}.channel`) === 'Erreur!' || data.get(`${message.guild.id}.time`) === 'Erreur!' || data.get(`${message.guild.id}.winnerstr`) === 'Erreur!' || data.get(`${message.guild.id}.price`) === 'Erreur!') {
        await data.set(`${message.guild.id}.creation`, 'off')
        return;
    }
    if (data.get(`${message.guild.id}.creation`) === 'off') {
